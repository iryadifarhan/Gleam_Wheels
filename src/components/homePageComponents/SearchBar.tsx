export function SearchBar(props: {
    ...
    return(
        <div className="searchBar flex mx-2 bg-[#3A94FF] px-3 py-2 rounded-3xl items-center gap-2">
            ...
            <input className="flex-auto bg-transparent border-none focus:outline-none text-white placeholder:italic placeholder:text-slate-300"
             type="text" value={props.search} placeholder="Cari layanan kebersihan" onChange={(e) => props.setSearch(e.target.value)}/>
        </div>
    )
}