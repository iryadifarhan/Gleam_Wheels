...
export function FilterComponent(props: {
    ...
    const filters = ["Terdekat", "Tersedia", "Rating tertinggi", "Full Car Wash", "Polishing", "Detailing", "Undercarriage", "Coating", "Paint Protection Film", "Interior"]
    ...
    return(
        ...
        <div className="flex overflow-x-scroll items-center h-10 gap-2 my-3 no-scrollbar">
            ...
            {filters.map((it, index) => 
                (<button onClick={index == 0 ? () => props.setFilterRange(index) : index == 1 ? () => props.setFilterAvailable(index) : index == 2 ? () => props.setFilterRating(index) : () => props.setFilterFeature(it, index)} 
